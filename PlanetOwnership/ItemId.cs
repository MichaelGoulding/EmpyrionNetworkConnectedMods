...
namespace PlanetOwnership
{
    class ItemId
    {
        public static int Small_Generator = 498;
        public static int Fuel_Tank = 259;

        public static int Ingot_Cobalt = 2273;
        public static int Ingot_Silicon = 2274;
        public static int Ingot_Neodymium = 2275;
        public static int Ingot_Copper = 2276;
        public static int Ingot_Sathium = 2285;

        //itemStacks.Add(new ItemStack(498, 10)); // small generator
        //itemStacks.Add(new ItemStack(259, 40)); // 
        ...
        //itemStacks.Add(new ItemStack(, 500)); // 2285     Ingot
